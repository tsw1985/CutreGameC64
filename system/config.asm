...
.label ZERO_PAGE_ROW_LOW_BYTE_CORNER_TANK_1   = ZERO_PAGE_ADDRESS + 14 // 
.label ZERO_PAGE_ROW_HIGHT_BYTE_CORNER_TANK_1 = ZERO_PAGE_ADDRESS + 15 //

.label ZERO_PAGE_ROW_LOW_BYTE_CORNER_TANK_2   = ZERO_PAGE_ADDRESS + 16 // 
.label ZERO_PAGE_ROW_HIGHT_BYTE_CORNER_TANK_2 = ZERO_PAGE_ADDRESS + 17 //