...
actions_in_raster:
    ...
    go_to_next_sprite:
        ...
        go_to_check_collision_in_tank_1:
            ...
            lda $d015       // detect if bullet 2 is visible
            and #%00001000
...
push_regs_to_stack()
    ...
    clc
    adc #TANK_MARGIN_X                       // x2 + 24 (derecha del tank 2)
    ...
    clc
    adc #TANK_MARGIN_X                          // x1 + 24 (derecha del tank 1)
    ...
    clc
    adc #TANK_MARGIN_Y                         // y2 + 21 (abajo del tank 2)
    ...
    clc
    adc #TANK_MARGIN_Y                          // y1 + 21 (abajo del tank 1)
