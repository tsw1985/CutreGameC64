...
push_regs_to_stack()
    ...
    clc
    adc #TANK_MARGIN                          // x2 + 24 (derecha del tank 2)
    ...
    clc
    adc #TANK_MARGIN                          // x1 + 24 (derecha del tank 1)
    ...
    clc
    adc #TANK_MARGIN                         // y2 + 21 (abajo del tank 2)
    ...
    clc
    adc #TANK_MARGIN                          // y1 + 21 (abajo del tank 1)
