...
player_1_str:     .text @"pla 1\$00"
player_2_str:     .text @"pla 2\$00"
author_str:       .text @"gabriel\$00"
help_str:         .text @"domingo\$00"
year_str:         .text @"2025\$00"
credits_str:      .text @"credits\$00"